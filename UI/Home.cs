...
namespace House_Rent
{
    public partial class Home : Form
    {
        ...
        {
            InitializeComponent();
            bunifuElipse.ApplyElipse(HomeSearchBox,20);
        }
        static string myconstring = ConfigurationManager.ConnectionStrings["Connection"].ConnectionString;

        //Search box text changed------------------------------
        private void HomeSearchBox_TextChange(object sender, EventArgs e)
        {
            string keyword = HomeSearchBox.Text;
        ...
        {
            //this.HomeSearchBox.FillColor = System.Drawing.Color.FromArgb(((int)(((byte)(x)))), ((int)(((byte)(y)))), ((int)(((byte)(z)))));
        }
        public void light()
        {
